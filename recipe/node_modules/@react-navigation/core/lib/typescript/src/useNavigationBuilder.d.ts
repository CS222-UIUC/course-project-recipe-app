...
import { DefaultNavigatorOptions, EventMapCore, PrivateValueStore } from '@react-navigation/core/lib/typescript/src/types';
/**
...
export default function useNavigationBuilder<State extends NavigationState, RouterOptions extends DefaultRouterOptions, ActionHelpers extends Record<string, () => void>, ScreenOptions extends {}, EventMap extends Record<string, any>>(createRouter: RouterFactory<State, any, RouterOptions>, options: DefaultNavigatorOptions<ParamListBase, State, ScreenOptions, EventMap> & RouterOptions): {
    ...
    navigation: {
        ...
        getParent<T = import("@react-navigation/core/lib/typescript/src/types").NavigationHelpers<ParamListBase, {}> | undefined>(id?: string | undefined): T;
        getState(): Readonly<{
            key: string;
            index: number;
            routeNames: string[];
    ...
    } & PrivateValueStore<[ParamListBase, unknown, unknown]> & import("@react-navigation/core/lib/typescript/src/types").EventEmitter<EventMap> & {
        setParams<RouteName_2 extends string>(params: Partial<object | undefined>): void;
    } & ActionHelpers;
    descriptors: Record<string, import("@react-navigation/core/lib/typescript/src/types").Descriptor<ScreenOptions, Omit<{
        dispatch(action: Readonly<{
            type: string;
            payload?: object | undefined;
            source?: string | undefined;
        ...
        getParent<T_1 = import("@react-navigation/core/lib/typescript/src/types").NavigationProp<ParamListBase, string, undefined, Readonly<{
            key: string;
            index: number;
            routeNames: string[];
            history?: unknown[] | undefined;
    ...
    } & import("@react-navigation/core/lib/typescript/src/types").EventConsumer<EventMap & EventMapCore<State>> & PrivateValueStore<[ParamListBase, string, EventMap]> & ActionHelpers, import("@react-navigation/core/lib/typescript/src/types").RouteProp<ParamListBase, string>>>;
