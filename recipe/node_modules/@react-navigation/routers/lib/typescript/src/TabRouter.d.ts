import type { DefaultRouterOptions, NavigationState, ParamListBase, Router } from '@react-navigation/routers/lib/typescript/src/types';
...
export default function TabRouter({ initialRouteName, backBehavior, }: TabRouterOptions): Router<TabNavigationState<ParamListBase>, import("@react-navigation/routers/lib/typescript/src/CommonActions").Action | TabActionType>;
